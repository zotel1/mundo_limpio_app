// Fábrica de instancias de Dio (cliente HTTP).
//
// Centraliza la creación de Dio con la configuración base:
// - URL base desde AppConfig
// - Timeouts de conexión y recepción
...
/// Fábrica que crea y configura instancias de [Dio].
///
/// Uso típico:
/// ```dart
...
class ApiClient {
  ...
  /// Crea una instancia de [Dio] con la configuración base.
  ///
  ...
  static Dio create({List<Interceptor>? extraInterceptors, String? baseUrl}) {
    ...
    // Logging para desarrollo — muestra requests y responses
