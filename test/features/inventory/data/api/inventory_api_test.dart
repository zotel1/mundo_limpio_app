...
void main() {
  ...
  group('getInventory', () {
    ...
    test(
      'debe GET /api/v1/inventory/{productId} y retornar InventoryResponse en 200',
      () async {
        ...
        when(
          () => mockDio.get('/api/v1/inventory/$testProductId'),
        ...
        verify(() => mockDio.get('/api/v1/inventory/$testProductId')).called(1);
      },
    );

    // Error 404: debe lanzar ApiException
    test(
      'debe lanzar ApiException en getInventory con not found (404)',
      () async {
        // Arrange: simula 404 Not Found
        when(() => mockDio.get('/api/v1/inventory/$testProductId')).thenThrow(
          DioException(
            requestOptions: RequestOptions(
              path: '/api/v1/inventory/$testProductId',
            ),
  ...
  group('adjustStock', () {
    ...
    test(
      'debe POST /api/v1/inventory/{productId}/adjust y retornar InventoryResponse en 200',
      () async {
        // Arrange
    ...
    test(
      'debe lanzar ApiException en adjustStock con bad request (400)',
      () async {
        // Arrange
        when(
          () => mockDio.post(
    ...
    test(
      'debe lanzar ApiException en adjustStock con conflict (409)',
      () async {
        // Arrange
        when(
          () => mockDio.post(
